...
public class MedicoService {
    ...
    private static final Logger logger =
        LoggerFactory.getLogger(MedicoService.class);
    ...
    public String GuardarMedico(Medico medico) {
        ...
        if (esNuevo) {
            ...
            crearDisponibilidadesIniciales(
                medicoGuardado
            );
        }
        ...
        logger.info(
            "Médico guardado: {} con disponibilidades iniciales creadas",
    ...
    @Transactional
    private void crearDisponibilidadesIniciales(
        Medico medico
    ) {

        String horarioStr =
            medico.getDisponibilidadHoraria();
        ...
        try {
            ...
            logger.info(
                "Disponibilidades iniciales creadas para médico {} - 30 días",
                medico.getId()
            );
            ...
            logger.error(
                "Error al crear disponibilidades iniciales para médico {}",
                medico.getId(),
                e
            );
    ...
    public String EliminarMedico(Long id) {
        ...
        List<Cita> citas =
            citaRepository.findByMedicoId(id);
